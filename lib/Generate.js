...
// primary function to obtain data of each employee
function Generate() {
    this.manager;
    this.engineer = [];
    this.intern = [];
...
// prompt for each employee's informtation
...
// function to add a prompt for selecting additional employees then continuing the prompts for the selected employee
Generate.prototype.initMainMenu = function() {
    ...
    .then(({menu}) => {
        ...
        // once all the employees are obtained, this if statement calls the function to creat the webpage
...
// function to create a html file utilizing the data generated from each amployee
...
// developing card on the html file for the manager
...
// developing card on the html file for the engineer
...
// developing card on the html file for the intern
